...
```
    ...
    /tmp/ipykernel_5939/290329474.py in <module>
         16 print(f"Overflow float to infinity: {overflow_float}")
         17 
    ---> 18 print(math.exp(1000))
...
rgb_triplet = [('110000', '11111111', '11110000')] # College Board example
...
```
    ...
    binary: 110000 11111111 11110000
    decimal 48 255 240
    proportion 0.18823529411764706 1.0 0.9411764705882353
...
```
    ...
    Algorithm N^2 took 1456.46 milliseconds
    Algorithm 10 times took 0.12 milliseconds
