...
var person = {
    name: "Chrissie Zhou",
    age: 15,
    currentClasses: ["AP Chem", "IED", "Calc AB"],
    interests: ["Volleyball", "Baking", "Reading"],
    heightInInches: 68,
    language: ["English", "Chinese"],
};

// Function to deep clone an object using JSON
function deepClone(obj) {
    return JSON.parse(JSON.stringify(obj));
}

// Clone the object to avoid manipulating the original
var clonedPerson = deepClone(person);

// Manipulate arrays within the cloned object
clonedPerson.currentClasses.push("CSP");
clonedPerson.interests.pop();


// Print the original object to show it remains unchanged
console.log("Original Object (Unchanged):");
console.log(person);

// Print the entire cloned object after manipulation
console.log("Cloned Object After Manipulation:");
console.log(clonedPerson);

// Perform mathematical operations on fields
var heightInFeet = person.heightInInches / 12;
console.log("Height in Feet:", heightInFeet.toFixed(2), "feet");
