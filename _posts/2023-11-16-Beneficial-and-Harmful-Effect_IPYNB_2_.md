...
- GPT 0: detects whether AI was used or not
...
- it can bad for the programmer and it could be bad for the users
...
- My daily screen time is around 5 hours. I use my phone to communicate with others, but I also end up getting stuck watching reels for hours
...
> -  repurposing social media for education offers significant potential benefits, such as global learning opportunities and resource sharing. However, some negatives might include information overload, privacy, and distractions

- How might you as a programmer implement code that helps your program have less unintented risks.

> - code review, automated testing, input validation, security audits, etc.
