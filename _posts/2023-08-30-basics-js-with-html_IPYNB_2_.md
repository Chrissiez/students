...
<body>
    <p>Switched!</p>
    <a id="Crumbl" href="https://crumblcookies.com/">Crumbl</a>
    <a id="Wushiland" href="https://www.wushiland-usa.com/">Wushiland</a>
    <button id="switchButton">Switch Links</button>

    <script>
        document.getElementById("switchButton").addEventListener("click", function() {
            // Get references to the two <a> elements
            var link1 = document.getElementById("Crumbl");
            var link2 = document.getElementById("Wushiland");
